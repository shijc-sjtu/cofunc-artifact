...
int sys_user_fault_map(badge_t client_badge, vaddr_t fault_va,
                       vaddr_t remap_va, bool copy, unsigned long perm)
{
        ...
        ret = map_range_in_pgtbl( fault_vmspace->pgtbl, fault_va, new_pa,
                                  PAGE_SIZE, perm, &rss);
