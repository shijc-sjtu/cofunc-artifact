...
const void *syscall_table[NR_SYSCALL] = {
        ...
        [CHCORE_SYS_create_device_pmo] = sys_create_device_pmo,
...
#ifdef CHCORE_SPLIT_CONTAINER
        /* Split Container */
        [CHCORE_SYS_split_container] = sys_split_container,
        [CHCORE_SYS_clone_pmo] = sys_clone_pmo,
#endif /* CHCORE_SPLIT_CONTAINER */
};
